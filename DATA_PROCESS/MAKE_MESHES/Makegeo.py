...
fname=f'Contour_{year}_Lucille.geo'
print('loading contour files...')
Contour_dir = f'../Contours/{year}_State/'
A1=np.loadtxt(Contour_dir+f'contours_2_{year}_Lucille.txt')
A2=np.loadtxt(Contour_dir+f'contours_1_{year}_Lucille_Clean.txt')
print('done.')
#%%
