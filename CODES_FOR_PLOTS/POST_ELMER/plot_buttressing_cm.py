...
def plot_strain(x, y, t11, t12, t21, t22, year, beta):
    ...
    plt.suptitle(f"strain rate for year {year}, friction param of {beta}") 
    plt.tight_layout()
    return fig, axes


def plot_stress(x, y, eig2_vx, eig2_vy, year, beta):
